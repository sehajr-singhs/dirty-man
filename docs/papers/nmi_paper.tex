...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item \textbf{Theory.} Three theorems: oracle-supervised routing learns the regime policy, structural adaptation needs asymptotically fewer labels than weight adaptation, and the shared bottleneck keeps switching geometry-continuous (Sec.~\ref{sec:theory}).
